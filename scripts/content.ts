...
function createContinentDiv(continent: string) {
...
function createContinentCheckbox(continent: string) {
...
function updateContinentDisplay(event: Event, continent: string) {
...
async function waitForPlotly(timeout = 5000): Promise<typeof Plotly | null> {
